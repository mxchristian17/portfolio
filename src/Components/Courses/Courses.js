...
export const Courses = () => {
  return (
    <div className="col col-lg-10 text-light text-start py-4 px-4">
        ...
        <p><FontAwesomeIcon icon={ faGraduationCap } /> CoderHouse - React Js (Top10% of 120 students)<a className="mx-2 btn btn-sm btn-outline-light" target="_blank" href="https://www.coderhouse.com/certificados/61e7654e6dd5d6007ce70afd?lang=es">Show certificate</a></p>
