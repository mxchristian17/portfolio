...
export const Courses = () => {
  return (
    <div className="col col-lg-10 text-light text-start py-4 px-4">
        ...
        <p><FontAwesomeIcon icon={ faTrophy } /> LinkedIn - Top-five percentile ranking in the PHP skill test <a href="https://www.linkedin.com/in/orengiachristian/" rel="noreferrer" alt="LinkedIn" target="_blank" className="px-1 text-light text-decoration-none"><FontAwesomeIcon icon={faLinkedin} swapOpacity /></a></p>
        <p><FontAwesomeIcon icon={ faTrophy } /> LinkedIn - Top-five percentile ranking in the JavaScript skill test <a href="https://www.linkedin.com/in/orengiachristian/" rel="noreferrer" alt="LinkedIn" target="_blank" className="px-1 text-light text-decoration-none"><FontAwesomeIcon icon={faLinkedin} swapOpacity /></a></p>
    </div>
  )
}
